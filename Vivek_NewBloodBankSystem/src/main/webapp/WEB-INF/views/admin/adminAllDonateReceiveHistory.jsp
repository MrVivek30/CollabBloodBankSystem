...
<body>
    <div class="container">
        <h2>Blood Bank History</h2>

     <form id="action-form" action="bloodHistory" method="post">
         <label for="action-select">Filter :</label>
        ...
        <table>
         ...
         <c:forEach var="request" items="${allBloodHistory}">
                <tr>
                    <td>${request.id}</td>
                    <td>${request.name}</td>
                    <td>${request.age}</td>
